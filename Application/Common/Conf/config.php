...
//*************************************附加设置***********************************
    ...
    'TMPL_PARSE_STRING'      => array(                           // 定义常用路径
        ...
        /*附加*/
        '__SHOW_CSS__'      => __ROOT__.trim(TMPL_PATH,'.').'Show/Public/css',
        '__SHOW_JS__'       => __ROOT__.trim(TMPL_PATH,'.').'Show/Public/js',
        '__SHOW_IMAGES__'   => OSS_URL.trim(TMPL_PATH,'.').'Show/Public/images',
    ),
//***********************************URL设置**************************************
    'MODULE_ALLOW_LIST'      => array('Home','Admin','Api','User','App','Show','Any'), //允许访问列表
